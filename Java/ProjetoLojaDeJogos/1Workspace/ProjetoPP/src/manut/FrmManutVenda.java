...
/**
A classe FrmManutVenda representa um formulário de manutenção de vendas.
...
public class FrmManutVenda extends JFrame {
	...
	public FrmManutVenda() {
		...
		(
				null, 
				"ATENÇÃO: Este formulário só deve ser utilizado em situações de emergência/erro de vendas realizadas pelo website!" //Avisa o usuário
		);
				...
				try
				{
					...
					if(!PpVendas.cadastrado(codigo))
					{
						...
						try
						{
							...
							{
								JOptionPane.showMessageDialog(null, "Não há mais este produto no estoque!");
							}
						}
						catch(Exception ex)
						{
							JOptionPane.showMessageDialog(null, "As informações digitadas não seguem o modelo padrão. Verifique também se os códigos do cliente e do produto são válidos.");
						}
					}
					else
						JOptionPane.showMessageDialog(null, "Já há uma venda cadastrado com esse código!");
			...
			public void actionPerformed(ActionEvent e) 
			{
				try
				{
					...
					if(PpVendas.cadastrado(codigo))
					{
						...
						{
							JOptionPane.showMessageDialog(null, "As informações digitadas não seguem o modelo padrão. Verifique também se o código da venda é válido.");
						}
					}
					else
						JOptionPane.showMessageDialog(null, "Não há uma venda cadastrada com esse código!");
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e)
			{
				try
				{
					...
					{
						JOptionPane.showMessageDialog(null, "Não há venda cadastrada com esse código!");
					}
				}
				catch(Exception ex)
				{
