...
/**
A classe FrmRelatMais representa um formulário de relatórios dos produtos mais vendidos.
...
@since 2019.
*/
public class FrmRelatMais extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmRelatMais frame = new FrmRelatMais();
	...
	public FrmRelatMais() {
		...
		lblAquiEstoListados = new JLabel("Aqui est\u00E3o listados os produtos cujas vendas s\u00E3o ou ultrapassaram um ter\u00E7o do total");
		lblAquiEstoListados.setForeground(new Color(0, 0, 0));
		lblAquiEstoListados.setFont(new Font("Tahoma", Font.PLAIN, 14));
		...
		btnAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				try
				{
					...
					int comparador = Math.round(qtasVendasNoTotal / 3.0F); //O comparador é de que os produtos ocupem ao menos um terço do total de vendas
		...
		try
		{
			...
			int comparador = Math.round(qtasVendasNoTotal / 3.0F);
